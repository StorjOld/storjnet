...
samples = [
    json.load(open("benchmark/filterupdates_push/sub_freq_test_a.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_b.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_c.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_d.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_e.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_f.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_g.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_h.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_i.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_j.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_k.json", "r")),
    json.load(open("benchmark/filterupdates_push/sub_freq_test_l.json", "r")),
]
...
# render
plt.savefig("benchmark/filterupdates_push/sub_freq_plot.png")
plt.show()
